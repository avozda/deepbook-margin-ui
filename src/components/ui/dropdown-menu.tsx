...
export const DropdownMenuSubContent = <T extends ValidComponent = "div">(
  ...
  return (
    <DropdownMenuPrimitive.SubContent
      ...
      class={cx(
        "bg-popover text-popover-foreground data-expanded:animate-in data-closed:animate-out data-closed:fade-out-0 data-expanded:fade-in-0 data-closed:zoom-out-95 data-expanded:zoom-in-95 z-50 min-w-32 origin-(--kb-menu-content-transform-origin) overflow-hidden rounded-md border p-1 shadow-lg outline-none",
...
export const DropdownMenuContent = <T extends ValidComponent = "div">(
  ...
  return (
    <DropdownMenuPrimitive.Content
      ...
      class={cx(
        "bg-popover text-popover-foreground data-expanded:animate-in data-closed:animate-out data-closed:fade-out-0 data-expanded:fade-in-0 data-closed:zoom-out-95 data-expanded:zoom-in-95 z-50 min-w-32 origin-(--kb-menu-content-transform-origin) overflow-x-hidden overflow-y-auto rounded-md border p-1 shadow-md outline-none",
